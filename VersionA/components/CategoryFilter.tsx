...
export function CategoryFilter({
  ...
  return (
    <section
      ...
      className="self-start lg:sticky lg:top-30"
    >
          ...
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className={`flex w-full cursor-pointer items-center justify-between rounded-xl border px-3 py-2.5 text-left text-[13px] font-medium transition ${
                  isActive
